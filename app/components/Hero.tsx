  ...
  return (
    <div className="lg:hidden fixed bottom-0 left-0 right-0 z-50 bg-white border-t border-gray-200 shadow-lg">
      <div className="flex gap-4 p-4">
        <Button
          className="bg-[#7b6824] hover:bg-stone-700 text-white text-xs py-2 px-4 h-auto rounded-xl flex items-center justify-center shadow-lg flex-1 gap-2"
          ...
          <div className="flex flex-col lg:grid lg:grid-cols-2 gap-6 lg:gap-16 items-start lg:items-center w-full lg:min-h-[600px]">
            ...
            <div className="flex flex-col justify-center lg:justify-center h-full text-left pt-8 lg:pt-0 space-y-6 lg:space-y-8">
              ...
              <div className="hidden lg:flex flex-col xl:flex-row gap-4 xl:gap-6">
                <Button
                  className="bg-[#7b6824] hover:bg-stone-700 text-white text-lg py-4 px-8 h-auto rounded-xl flex items-center justify-center font-bold shadow-xl transition-all duration-300 gap-3 min-w-[280px]"
                  onClick={handleWhatsAppClick}
                >
