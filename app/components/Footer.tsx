      ...
      <div className="container mx-auto px-4 max-w-7xl">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 mb-8">
          ...
          <div>
            <ul className="space-y-0">
              <li>
                <a
                  href="#"
                  className="text-[#7b6824] hover:text-[#5a4e1a] font-medium"
                >
                  About Us
                </a>
              </li>
          ...
          <div className="text-center lg:text-left">
            <h3 className="text-lg font-semibold text-[#7b6824] mb-4">
            ...
            <p className="text-lg font-semibold text-[#7b6824]">
              NABH & JCI Accredited
            </p>
          </div>
          ...
          <div>
            ...
            <div className="flex items-start gap-2 mb-3">
              ...
              <p className="text-[#7b6824] text-sm leading-relaxed">
                Sector 51, Main Road, Opposite Village Wazirabad, Near United
                Nations Park, Gurugram, Haryana - 122003
              </p>
            </div>
        ...
        <div className="flex justify-center gap-4 mb-6">
          <a
            href="#"
            className="w-12 h-12 bg-[#7b6824] rounded-full flex items-center justify-center hover:bg-[#5a4e1a] transition-colors"
          >
        ...
        <div className="border-t border-gray-400 pt-6">
          <div className="flex flex-col lg:flex-row justify-between items-center gap-4">
            ...
            <div className="flex flex-wrap justify-center lg:justify-end items-baseline gap-4 text-sm text-[#7b6824] order-1 lg:order-2">
              <a href="#" className="hover:text-[#5a4e1a]">
                Corporate Info
              </a>
